...
title(xlab = 'Forcing variable (as ratio)', ylab = 'Density', main = 'McCrary test for Net Worth sample')



dev.print(pdf, "output/Figure_IA_5.pdf")
...
print(xtable(RDD_panel,digits=c(0, 2, 2, 2, 4, 0, 0)), include.rownames = FALSE,
      file = "output/Table_6_Panel_A.txt")
